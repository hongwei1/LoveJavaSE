...
/**
 * Realization of a list by means of a dynamic array. This is a simplified version of the
...
public class ArrayList<E> implements List<E>
{
	...
	/**
	 * Inserts the given element at the specified index of the list, shifting all subsequent
	 * elements in the list one position further to make room.
	 * 
	 * @param i
	...
	/**
	 * Removes and returns the element at the given index, shifting all subsequent elements in the
	 * list one position closer to the front.
	 * 
	 * @param i
	...
	/**
	 * Produces a string representation of the contents of the indexed list. This exists for
