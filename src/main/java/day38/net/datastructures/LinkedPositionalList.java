 ...
 */
package day38.net.datastructures;
...
public class LinkedPositionalList<E> implements PositionalList<E>
{
	// ---------------- nested Node class ----------------
	/**
	 * Node of a doubly linked list, which stores a reference to its element and to both the
	...
	/**
	 * Returns the given node as a Position, unless it is a sentinel, in which case null is returned
	 * (so as not to expose the sentinels to the user).
	 */
	...
	// private utilities
	/**
	 * Adds an element to the linked list between the given nodes. The given predecessor and
	 * successor should be neighboring each other prior to the call.
	 *
	 * @param pred
	...
	/**
	 * Removes the element stored at the given Position and returns it. The given position is
	...
	/**
	 * A (nonstatic) inner class. Note well that each instance contains an implicit reference to the
	 * containing list, allowing us to call the list's methods directly.
	 */
	...
	// Debugging code
	/**
	 * Produces a string representation of the contents of the list. This exists for debugging
	 * purposes only.
	 */
	@Override
