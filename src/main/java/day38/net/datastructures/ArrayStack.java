...
/**
 * Implementation of the stack ADT using a fixed-length array. All operations are performed in
 * constant time. An exception is thrown if a push operation is attempted when the size of the stack
...
public class ArrayStack<E> implements Stack<E>
{
	...
	/**
	 * Produces a string representation of the contents of the stack. (ordered from top to bottom).
