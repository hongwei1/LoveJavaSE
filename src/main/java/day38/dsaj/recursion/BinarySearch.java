...
public class BinarySearch
{
	...
	/**
	 * Returns true if the target value is found in the indicated portion of the data array. This
	 * search only considers the array portion from data[low] to data[high] inclusive.
	 */
