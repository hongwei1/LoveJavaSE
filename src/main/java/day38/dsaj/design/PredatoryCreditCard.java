...
import day38.dsaj.primer.CreditCard;
...
public class PredatoryCreditCard extends CreditCard
{
	 ...
	 */
	public PredatoryCreditCard(String cust, String bk, String acnt, int lim, double initialBal,
			double rate)
	{
	...
	@Override
	/**
	 * Charges given price to the card, assuming sufficient credit limit. Returns true if charge was
	 * processed. Returns false and assesses $5 fee if charge is denied.
	 */
	...
	{
		PredatoryCreditCard card = new PredatoryCreditCard("Michael", "Payday",
				"1111 1111 1111 1111", 2500, 0, 0.0825);
		card.charge(1000);
