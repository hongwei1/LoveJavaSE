...
class Demo3 {
	public int method(int[] arr, int index) throws FuShuIndexException// throws
...
class ExceptionDemo3 {
	public static void main(String[] args) throws FuShuIndexException  // throws
																		// FuShuIndexException
	{
		int[] arr = new int[3];
		int []arr1 = null;
 ...
 * public String getName() { return name; } } class Student extends Person {
