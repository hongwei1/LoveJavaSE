package itcastday20.p1.otherapi;
...
public class DateDemo
{
	 ...
	 * 日期对象和毫秒值之间的转换。
	 *
	 * 毫秒值-->日期对象 ： 1，通过Date对象的构造方法 new Date(timeMillis); 2，还可以通过setTime设置。 因为可以通过Date对象的方法对该日期中的各个字段(年月日等)进行操作。
	 * 
	 *
	 * 日期对象-->毫秒值： 2，getTime方法。 因为可以通过具体的数值进行运算。
	 *
	 *
	 */
